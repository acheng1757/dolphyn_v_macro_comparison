...
macro_base_dir = "/Users/abbie/Desktop/Dolphyn_to_Macro/Dolphyn vs. Macro/1 Week Multi Sector/Macro"
dolphyn_base_dir = "/Users/abbie/Desktop/Dolphyn_to_Macro/Dolphyn vs. Macro/1 Week Multi Sector/Dolphyn"

scenario_folders = [
    "NineZones_High_Biomass_High_CO2/results_001/results",
...
scenario_labels = {
    "NineZones_High_Biomass_High_CO2/results_001/results": "High biomass\nHigh CO2",
...
def get_scenario_root_from_results_scenario(scenario):
    """
    Convert:
        NineZones_X_Biomass_X_CO2/results_001/results
    to:
        NineZones_X_Biomass_X_CO2
    """
    return scenario.split("/results_001/results")[0]
...
def add_balance_labels(df):
    ...
    is_bioenergy_ng = (
        ...
        (
            (
                edge_lower.str.contains("_fuel_edge", na=False) &
                (~edge_lower.str.contains("jet", na=False))
            ) |
            edge_lower.str.contains("natgas", na=False)
        )
    )
