...
from lcoe.liquid_fuels.bio_liquid_fuels_lcoe.a_json_to_csv import ASSET_FILES

TEMPLATE_XLSX_PATH = os.path.join(SCRIPT_DIR, "LCOE_BIOLF_TEMPLATE.xlsx")

CSV_TO_XLSX_MAP = {
    "id":                  "id",
    "biomass_commodity":           "commodity",
    "electricity_consumption":    "elec_consumption (MWh/t-bio)",
    "electricity_production":     "elec_production (MWh/t-bio)",
    "gasoline_production": "gasoline_production (MWh-gasoline/t-bio)",
    "diesel_production": "diesel_production (MWh-diesel/t-bio)",
    "jetfuel_production": "jetfuel_production (MWh-jetfuel/t-bio)",
    "natgas_consumption":  "natgas_consumption (MWh/t-bio)",
    "co2_content":  "co2_biomass_content (t-CO2/t-bio)",
    "capture_rate":        "process_capture_rate (t-CO2/t-bio)",
    "emission_rate":       "process_emission_rate (t-CO2/t-bio)",
...
for label in scenario_names:
    ...
    out_xlsx_path = os.path.join(SCRIPT_DIR, f"LCOE_BIOLF_{label}.xlsx")
