...
from lcoe.ethylene.synthetic_ethylene.a_json_to_csv import ASSET_FILES

TEMPLATE_XLSX_PATH = os.path.join(SCRIPT_DIR, "LCOE_SYNTHETIC_TEMPLATE.xlsx")

CSV_TO_XLSX_MAP = {
    "id":                  "id",
    "h2_consumption":      "h2_consumption (MWh/t-CO2Captured)",
...
for label in scenario_names:
    ...
    out_xlsx_path = os.path.join(SCRIPT_DIR, f"LCOE_SYNTHETIC_{label}.xlsx")
